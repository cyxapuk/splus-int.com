...
<body>
	<div class="container">
	  ...
	  <div class="row">  
            ...
            <p class="more-link"><a class="btn btn-warning" data-toggle="modal" href="#myModal{$array.objectlist[1].object_id}"></a></p>
            {/if}
            </div>
      		<div class="span2"></div>
      		<div class="span4 box">
            ...
            <p class="more-link"><a class="btn btn-warning" data-toggle="modal" href="#myModal{$array.objectlist[2].object_id}"></a></p>
            {/if}
            </div>
            <div class="span1"></div>                        
      </div>
	  ...
	  <div class="row">  
            ...
            <p class="more-link"><a class="btn btn-warning" data-toggle="modal" href="#myModal{$array.objectlist[3].object_id}"></a></p>
            {/if}
            </div>
      		<div class="span2"></div>
      		<div class="span4 box">
            ...
            <p class="more-link"><a class="btn btn-warning" data-toggle="modal" href="#myModal{$array.objectlist[4].object_id}"></a></p>
            {/if}
            </div>
            <div class="span1"></div>                        
      </div>      
